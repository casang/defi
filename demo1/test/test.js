...
describe('TokenPaymentSplitter Tests', () => {
    ...
    beforeEach(async () => {
        ...
        console.log (testPaymentToken)
        console.log ("testPaymentToken.address")
        console.log (testPaymentToken.runner.address)
        console.log (ethers.address(testPaymentToken))
        console.log ("testPaymentToken.address fim")
    ...
    describe('Add payees with varying amounts and distribute payments', async () => {
        ...
        it('payment token is distributed evenly to multiple payees', async () => {
                ...
                mockPool = await MockPool.deploy(
                    payeeAddressArray,
                    payeeShareArray,
                    testPaymentToken.runner.address
                )
                await mockPool.waitForDeployment()
    
                await testPaymentToken.mint(mockPool.runner.address, 100000)
                console.log (mockPool.runner.address)
